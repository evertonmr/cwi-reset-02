...
public class BancoDaDesgraca {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ContaBancaria bbCc = new ContaCorrente(123 , BANCO_DO_BRASIL, 00.00);
        ContaBancaria bradescoCc = new ContaCorrente(123, BRADESCO, 00.00);
        ContaBancaria caixaCc = new ContaCorrente(123, CAIXA, 00.00);
        ContaBancaria itauCc = new ContaCorrente(123, ITAU, 00.00);
        ContaBancaria nubankCc = new ContaCorrente(123, NUBANK, 00.00);
        CONTAS_CORRENTE.addAll(asList(bbCc, bradescoCc, caixaCc, itauCc, nubankCc));

        ContaBancaria bbPoupanca = new ContaPoupanca(123, BANCO_DO_BRASIL, 00.00);
        ContaBancaria bradescoPoupanca = new ContaPoupanca(123, BRADESCO, 00.00);
        ContaBancaria caixaPoupanca = new ContaPoupanca(123, CAIXA, 00.00);
        ContaBancaria itauPoupanca = new ContaPoupanca(123, ITAU, 00.00);
        CONTAS_POUPANCA.addAll(asList(bbPoupanca, bradescoPoupanca, caixaPoupanca, itauPoupanca));

        ContaBancaria itauDigital = new ContaDigital(123, ITAU, 00.00);
        ContaBancaria nubankDigital = new ContaDigital(123, NUBANK, 00.00);
    ...
    private static void verificarContasQueNaoPodemSerCriadas() {
        ...
        contaInvalida(() -> new ContaDigital(123, BANCO_DO_BRASIL, 00.00));
        contaInvalida(() -> new ContaDigital(123, BRADESCO, 00.00));
        contaInvalida(() -> new ContaDigital(123, CAIXA, 00.00));

        contaInvalida(() -> new ContaPoupanca(123, NUBANK, 00.00));
    }
    ...
    private static void contaInvalida(Supplier<ContaBancaria> conta) {
        ...
        } catch (TipoDeContaException ibie) {
        }
    }
